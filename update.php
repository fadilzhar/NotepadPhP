...
<html lang="en">
    <head>
        ...
        <title> Edit Private Notes </title>
            ...
            <div class="card shadow bg-body-tertiary rounded mb-4">
                <div class="card-body">
                    <form class="d-flex" action="updateupdate.php" method="post" >
                        <input class="form-control me-2 mb-2" name="title_note" placeholder="TITLE..." value="<?php echo $result['title_note'] ?>">
                        <input class="form-control me-2 mb-2" name="note_note" placeholder="TYPE..." value="<?php echo $result['note_note'] ?>">
