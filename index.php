            ...
            <div class="card shadow bg-body-tertiary rounded mb-4">
                <div class="card-body">
                    <form class="d-flex" action="insert.php" method="post" >
                        <input class="form-control me-2 mb-2" name="title_note" placeholder="TITLE...">
                        <input class="form-control me-2 mb-2" name="note_note" placeholder="TYPE...">
                  ...
                  <div class="carousel-item active">
                    <div class="card text-center mb-4">
                        ...
                        <div class="card-body bg-dark">
                          <h5 class="card-title text-primary "> <?php echo $result ['title_note'] ?> </h5>
                          <p class="card-text text-primary"> <b> <?php echo $result['note_note'] ?> </b> </p>
                          <a href="update.php?edit=<?php echo $result['id_note'] ?>" class="btn btn-primary btn-outline-light"> Edit </a>
